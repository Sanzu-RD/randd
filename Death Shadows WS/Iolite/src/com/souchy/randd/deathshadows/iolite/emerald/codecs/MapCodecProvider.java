package com.souchy.randd.deathshadows.iolite.emerald.codecs;
...
//		if (Map.class.isAssignableFrom(type) && type.getTypeParameters().size() == 2) {
//            return new com.souchy.randd.deathshadows.iolite.emerald.codecs.MapCodec(type.getType(), registry.get(type.getTypeParameters().get(0)), registry.get(type.getTypeParameters().get(1)));
//        } else {
//            return null;
//        }
//	}
