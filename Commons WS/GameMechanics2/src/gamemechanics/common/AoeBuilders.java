...
public class AoeBuilders {
		...
		// je le laisse pour l'instant, mais pas besoin de ça. Il vaut mieux faire aoe = rect(3,3).sub(rect(2,2);
...
//			
//		};
		// je le laisse pour l'instant, mais pas besoin de ça. Il vaut mieux faire aoe = circle(3,3).sub(circle(2,2);
