...
public interface IEffect extends Identifiable<Integer> {
	...
	/**
	 * J'sais pas si c'est une bonne id�e cette fonction,
	 * <br>
	 * Mais �a serait pour choisir si l'effet est visible dans la barre des effets du personnage.
	 * <br>
	 * Ex certains passifs pourraient ptete �tre cach�s.
	 */
