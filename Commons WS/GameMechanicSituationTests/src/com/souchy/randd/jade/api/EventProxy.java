...
public interface EventProxy {
	...
	/**
	 * Routes EVERY events from this proxy to the target proxy
	 *<br>
	 * The parameter proxy will receive every event that this proxy receives
	 * @param proxy
	 * @return
	 */
	 ...
	 * @param list - Liste de trucs � foreach qu'on utilise pour cr�er et poster l'event
	 * @param eventCreator
	 */
