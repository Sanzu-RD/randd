...
public class Situation7Matrixes {
	...
	public static class BleedStatus extends Status {
		...
		public BleedStatus(FightContext context, Character source, Character target) {
			...
			// TODO faudrait mettre les param�tres de dommages dans le ctor du bleedstatus
		...
		public void registerHandlers() {
			...
			this.<OnTurnEndHandler>register((e) -> {
				target().getPos().getCells().forEach(c -> {
					...
					// TODO devrait mettre un flag dans le context pour dire si un character a d�j� �t� affect� par un m�me effet
					// pour pas l'affecter 2 fois (via aoe sur une entit� 2x2) d'un coup
