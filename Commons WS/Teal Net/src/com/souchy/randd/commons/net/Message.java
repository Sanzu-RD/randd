...
/**
 * 
 * Un Message est � la fois un Message, un Serializer, un Deserializer et une
 * Factory.
 * <p>
 * On se sert de la Factory pour cr�er un Deserializer qui retourne le bon
 * Message.
 * <p>
 * Ce qui veut dire :
 * 
 ...
 * </pre>
 * 
 * Ainsi on peut cr�er une liste de Factories qui cr�ent des Deserializer qui
 * retourne le bon Message, ce qui restreint l'acc�s aux autres methods.
 * <p>
 * Pour cr�er un Serializer, toujours passer par le constructeurr du Message pour
