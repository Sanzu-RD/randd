...
public class FirePunch extends Spell {

	public static final int modelid = Elements.fire.makeid(1, 3);

	public Damage e1;
	
	public FirePunch(Fight f) {
		super(f);
		var formula = new ElementMap();
		formula.put(Elements.fire, new IntStat(70, 0, 10, 0));
	...
	protected void initBaseStats(SpellStats stats) {
		...
		stats.maxRangeRadius.baseflat = 1;
	}
	...
	public void cast0(Creature caster, Cell target) {
		Log.info("FirePunch cast: " + caster + ", " + target);
		e1.apply(caster, target);
	}

	@Override
	public Spell copy(Fight fight) {
		var s = new FirePunch(fight);
		s.stats = stats.copy();
