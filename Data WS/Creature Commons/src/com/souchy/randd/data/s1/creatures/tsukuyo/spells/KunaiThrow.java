...
public class KunaiThrow extends Spell {

	public static final int modelid = Elements.normal.makeid(1, Tsukuyo.modelid, 1);
	
	public Damage e1;
	
	public KunaiThrow(Fight f) {
		super(f);
