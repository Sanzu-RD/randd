...
public class FireStorm extends Spell {
	...
	public static final int modelid = Elements.fire.makeid(1, 4);

	public Damage e1;
	
	public FireStorm(Fight f) {
		super(f);
		var formula = new HashMap<Element, IntStat>();
		formula.put(Elements.fire, new IntStat(30, 0, 10, 0));
	...
	public void cast0(Creature caster, Cell target) {
		Log.info("FireStorm cast: " + caster + ", " + target);
		e1.apply(caster, target);
	}
	
	@Override
	public Spell copy(Fight fight) {
		var s = new FireStorm(fight);
		s.stats = stats.copy();
