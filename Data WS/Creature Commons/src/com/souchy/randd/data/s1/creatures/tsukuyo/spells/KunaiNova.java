...
public class KunaiNova extends Spell {

	public static final int modelid = Elements.normal.makeid(1, Tsukuyo.modelid, 3);
	
	public Damage e1;
	
	public KunaiNova(Fight f) {
		super(f);
