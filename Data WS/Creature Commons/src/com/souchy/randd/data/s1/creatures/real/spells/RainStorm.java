...
public class RainStorm extends Spell {

	public static final int modelid = Elements.water.makeid(1, Real.modelid, 1);
	
	public Damage e1;
	
	public RainStorm(Fight f) {
		super(f);
		var formula = new HashMap<Element, IntStat>();
		formula.put(Elements.water, new IntStat(50, 0, 10, 0));
		e1 = new Damage(AoeBuilders.circle.apply(5), TargetType.full.asStat(), formula);
	}
