...
public class FBOTest implements ApplicationListener {
	...
	@Override
	public void create() {
		atlas = new Texture(Gdx.files.internal("data/textures/slider.png"));
		...
		assets.load("models/Wasp.g3dj", Model.class);
		assets.finishLoading();
		Model m = assets.get("models/Wasp.g3dj");
