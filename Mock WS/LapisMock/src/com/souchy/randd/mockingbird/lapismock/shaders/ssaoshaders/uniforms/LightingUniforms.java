...
public class LightingUniforms implements UniformsModule {
	...
	public LightingUniforms(BaseShader s, Renderable renderable, Config config, Attributes attributes) {
		lighting = renderable.environment != null;
		environmentCubemap = attributes.has(CubemapAttribute.EnvironmentMap)
			|| (lighting && attributes.has(CubemapAttribute.EnvironmentMap));
		shadowMap = lighting && renderable.environment.shadowMap != null;
