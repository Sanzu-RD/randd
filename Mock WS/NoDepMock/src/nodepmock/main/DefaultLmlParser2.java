...
import com.github.czyzby.lml.parser.impl.DefaultLmlStyleSheet;
import com.github.czyzby.lml.parser.impl.DefaultLmlSyntax;
import com.github.czyzby.lml.parser.impl.DefaultLmlTemplateReader;
...
public class DefaultLmlParser2 extends AbstractLmlParser {
    /** Helper variable. Keeps reference to currently nearest nested parent. Never a macro tag. */
    protected LmlTag currentParentTag;
    ...
    public DefaultLmlParser2(final LmlData data) {
    ...
    public DefaultLmlParser2(final LmlData data, final LmlSyntax syntax) {
    ...
    public DefaultLmlParser2(final LmlData data, final LmlSyntax syntax, final LmlTemplateReader templateReader) {
    ...
    protected void processConditionArgument(final String argument, final StringBuilder conditionBuilder) {
    ...
    protected void processSchemaComment() {
        // Removing DOCTYPE:
    ...
    protected void processNestedComment() {
    ...
    protected void processTag(final StringBuilder builder) {
    ...
    protected void processTagEntity(final StringBuilder rawTagData) {
    ...
    protected static int getTagNameEndIndex(final StringBuilder rawTagData) {
    ...
    protected void processMacro(final String macroName, final StringBuilder rawTagData) {
    ...
    protected void burnCharacters(final int charactersAmount) {
    ...
    protected int isSameMacroTagName(final LmlTag macroTag, final StringBuilder tagNameBuilder) {
    ...
    protected boolean isCurrentMacroTagChild(int additionalIndexesToPeek) {
        while (templateReader.hasNextCharacter(additionalIndexesToPeek)) {
            final char character = templateReader.peekCharacter(additionalIndexesToPeek++);
    ...
    protected boolean isLastCharacterInMacroTag(int additionalIndexesToPeek) {
        while (templateReader.hasNextCharacter(additionalIndexesToPeek)) {
            final char character = templateReader.peekCharacter(additionalIndexesToPeek++);
