...
interface LapisScreenRenderer extends Screen {
	...
	public static boolean cullback = true; // déjà seté dans les shader classes DefaultShader.Config et DepthShader.Config
	...
	public default void render(float delta) {
		...
		Texture tex = onlyShadowMap ? getShadowLight().getFrameBuffer().getColorBufferTexture() : getFBO().getColorBufferTexture();
