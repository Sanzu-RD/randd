...
interface LapisScreenRenderer extends Screen {
	...
	public default void render(float delta) {
		...
		{
			// test to render shadow depth map
			//var tex1 = getShadowLight().getFrameBuffer().getColorBufferTexture(); //.getDepthMap().texture; //getShadowLight().getFrameBuffer().getColorBufferTexture();
			//fboRegion = new TextureRegion((Texture) tex1);
			//fboRegion.flip(false, true);
