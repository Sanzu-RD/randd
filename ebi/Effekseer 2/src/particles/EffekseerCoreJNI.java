...
class EffekseerCoreJNI {
	...
	public final static native boolean EffekseerEffectCore_LoadTexturePath(long jarg1, EffekseerEffectCore jarg1_, String jarg2, int jarg3, int jarg4,
			int jarg5);
	...
	public final static native void EffekseerManagerCore_SetProjectionMatrix(long jarg1, EffekseerManagerCore jarg1_, float[] projection, float[] camera,
			boolean view, float viewPortWidth, float viewPortHeiht);
	...
	public final static native void EffekseerManagerCore_SetEffectPosition(long jarg1, EffekseerManagerCore jarg1_, int jarg2, float jarg3, float jarg4,
			float jarg5);
