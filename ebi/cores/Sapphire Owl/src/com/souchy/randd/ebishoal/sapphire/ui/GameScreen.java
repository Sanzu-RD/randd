...
public class GameScreen extends ComposedScreen {
	...
	private float aspectRatio = 16/9f;	// ratio � mettre dans les settings public
	private float minWorldY = 50; 		// hauteur min � mettre ds settings priv�s
	...
	protected Camera createCam() {
		...
		float far = 1000f; 		  // � mettre dans les settings
