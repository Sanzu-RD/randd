...
public class GameScreenHud extends Screen2d {
	...
	public GameScreenHud() {
		Texture honkongTex = new Texture(Gdx.files.internal("res/ui/gdx/hongkonghustle-hiero-100_00.png"), true); // true enables mipmaps
		honkongTex.setFilter(TextureFilter.MipMapLinearNearest, TextureFilter.Linear); // linear filtering in nearest mipmap image
		BitmapFont hongkongFont = new BitmapFont(Gdx.files.internal("res/ui/gdx/hongkonghustle-hiero-100.fnt"), new TextureRegion(honkongTex), false);
		hongkong.font = hongkongFont;

		Texture defaultTex = new Texture(Gdx.files.internal("res/ui/gdx/default.png"), true); // true enables mipmaps
		defaultTex.setFilter(TextureFilter.MipMapLinearNearest, TextureFilter.Linear); // linear filtering in nearest mipmap image
		BitmapFont defaultFont = new BitmapFont(Gdx.files.internal("res/ui/gdx/default.fnt"), new TextureRegion(defaultTex), false);
